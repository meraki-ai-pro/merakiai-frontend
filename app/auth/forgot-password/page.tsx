  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#edf6fb] px-5 py-12 dark:bg-slate-950 sm:px-8">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-6rem)] max-w-6xl items-center justify-center">
        <div className="grid w-full overflow-hidden rounded-[32px] border border-white/[0.7] bg-white/[0.80] shadow-2xl shadow-blue-950/[0.1] backdrop-blur-xl dark:border-white/[0.1] dark:bg-white/[0.06] lg:grid-cols-[0.9fr_1.1fr]">
