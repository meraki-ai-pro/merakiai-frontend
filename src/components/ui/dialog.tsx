...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    {/* Centred with inset-0 + m-auto, not left/top 50% + translate: the
        global .animate-in in app/globals.css ends on a transform and holds it
        (forwards), which cancelled the translate and pushed every dialog
        half off the screen. Margins are immune to that. */}
